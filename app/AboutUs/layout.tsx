...
export const metadata: Metadata = {
  ...
  description: "Learn about Jharkhand Public School's journey since 2010. Discover our child-first approach, academic excellence, and commitment to nurturing young minds in Barharwa, Jharkhand. Meet our passionate educators and explore our educational philosophy.",
  keywords: [
    "Jharkhand Public School about",
    "JPS history",
    "school story since 2010",
  ...
  openGraph: {
    title: "About Jharkhand Public School | Our Educational Journey Since 2010",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Jharkhand Public School - About Us - Educational Excellence Since 2010",
        type: "image/jpeg",
      },
      {
  ...
  twitter: {
    ...
    title: "About Jharkhand Public School | Our Story Since 2010",
