      ...
      faqs: [
        {
          ...
          answer: "Admission process includes filling the application form, document verification, and interaction with the child. No entrance exam is required for nursery to class 5."
        },
        {
