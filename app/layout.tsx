...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Best primary school in Jharkhand",
    "Nursery to Class 5 school",
    "School admission Jharkhand",
    " junior school",
    "Creative learning for kids",
    "Early childhood education",
    "Values-based education",
    "Quality education in Jharkhand",
    "School for young minds",
    "Jharkhand education",
    "Barharwa school",
    "Primary school Barharwa",
    "School with values",
    "Creative education Jharkhand",
    "Nurturing young minds",
    "School for holistic development",
    "Best school in Barharwa",
    "Jharkhand Public School Barharwa",
    "Early education Jharkhand",
    "School for creativity and values",
    "Inclusive education Jharkhand",
    ...
    "School for character development",
    "School for academic excellence",
    "School with a nurturing environment",
    "School for all-round development",
    "School for young learners",
    "School with a focus on creativity",
    "School for building confidence",
    "School for developing skills",
    "School for fostering curiosity",
    "School for inspiring young minds",
    "School for shaping future leaders",
    "School for community engagement",
    "School for cultural enrichment",
    "School for social responsibility",
    ...
    "School for problem-solving skills",
    "School for teamwork and collaboration",
    "School for effective communication",
    "School for leadership development",
    "Hindi medium school",
    "JAC board school",
    "Jharkhand school admission",
    "School for holistic education",
    "School for character building",
  ...
  openGraph: {
    ...
    description:
      "Empowering young minds through early education, values, and creativity in Jharkhand.",
